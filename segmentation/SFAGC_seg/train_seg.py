...
def parse_args():
    ...
    parser.add_argument('--num_part', type=int, default=50, help='parts number')
    parser.add_argument('--k', type=int, default=[20,32,64], help='k-NN')
    parser.add_argument('--pool_n', type=int, default=[512,128], help='sub-point number')
...
def main(args):
    ...
    classifier = MODEL.Network(args.npoint,args.k,args.pool_n,args.num_part).cuda()
